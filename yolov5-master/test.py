...
if __name__ == '__main__':
    ...
    my_weights=['./myweights/best_17_25.pt','./myweights/best_17_30.pt',
                './myweights/best_coco_scratch_230.pt','./myweights/best_coco_transfer.pt',
                './myweights/best_crowdhuman_scratch_250.pt']
